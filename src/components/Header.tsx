...
export function Header(props: Menu) {
  ...
  return (
    <header className="w-full py-5 flex gap-4 justify-between px-6 place-content-center bg-gray-700 border-b border-gray-600 group">
      <Logo />
      <button className="hidden xl:block border px-2 border-green-300 rounded" onClick={() => navigate('/')}>Deslogar</button>
